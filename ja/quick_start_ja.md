# Quick Start
## 1. インストール
GitHubのLCEMUの[公式レポジトリ](https://github.com/UnknownLTAS/LCEMU/releases)から最新のリリース(7z)をダウンロードしてください。設定や使い方のほとんどはCemuと一緒です。[Cemu Guide](https://cemu.cfw.guide/)を読んでください。
...
これらの詳しい説明は[ドキュメント](./document_ja.md)にあります。
